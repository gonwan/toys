...
import com.gonwan.toys.counter.snapshot.CounterSnapshotFile;
...
import static com.gonwan.toys.counter.CounterOperation.GET;
import static com.gonwan.toys.counter.CounterOperation.INCREMENT;
...
public class CounterStateMachine extends StateMachineAdapter {
    ...
    private static ThreadPoolExecutor executor   = ThreadPoolUtil
                                                     ...
                                                     .threadFactory(new NamedThreadFactory("JRaft-Test-Executor-", true))
                                                     .build();
    /**
     * Counter value
     */
