...
import com.gonwan.toys.counter.rpc.CounterOutter.ValueResponse;
import com.gonwan.toys.counter.rpc.GetValueRequestProcessor;
import com.gonwan.toys.counter.rpc.IncrementAndGetRequestProcessor;
...
public class CounterServer {
    ...
    public static void main(final String[] args) throws IOException {
        if (args.length != 4) {
            System.out.printf("Usage: java %s {groupId} {dataPath} {serverId} {initConf}\n", CounterServer.class);
            System.out.printf("Example: java %s counter /tmp/server1 127.0.0.1:8081 127.0.0.1:8081,127.0.0.1:8082,127.0.0.1:8083\n", CounterServer.class);
            System.exit(1);
        }
